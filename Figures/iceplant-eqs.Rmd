...
We could not find parameter values for establishment probability ($p_e$) or seedbank survival rate ($s_{sb}$). Therefore, we simulated a range of values  from 0-1 for each (incrementing by 0.05), re-building the model, and then computing $\lambda$. The results are reported here.
